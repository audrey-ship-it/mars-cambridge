function make(title,intro,guide,concepts,rows){const items=rows.map(([s,z,a,o,w,e,c,x])=>({s,z,a,o,w,e,c,x}));return{title,intro,guide,questions:[...concepts,...items.slice(0,15-concepts.length).map(i=>({q:i.s,qZh:i.z,opts:i.o,ans:i.o.indexOf(i.a),expZh:i.x}))],blanks:items.map(i=>({sentence:i.s,sentenceZh:i.z,ans:[i.a],expZh:i.x})),corrections:items.map(i=>({sentence:i.w,sentenceZh:i.z,error:i.e,correct:i.c,expZh:i.x}))}}
const proper=[
