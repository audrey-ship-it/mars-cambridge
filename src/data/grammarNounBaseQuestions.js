function make(title,intro,guide,concepts,rows,showCapitalizationPrompt=false){const items=rows.map(([s,z,a,o,w,e,c,x,correctionZh])=>({s,z,a,o,w,e,c,x,correctionZh}));return{title,intro,guide,questions:[...concepts,...items.slice(0,15-concepts.length).map(i=>({q:i.s,qZh:i.z,opts:i.o,ans:i.o.indexOf(i.a),expZh:i.x}))],blanks:items.map(i=>({sentence:showCapitalizationPrompt?i.s.replace(/\.$/,` (${i.a.toLowerCase()}).`):i.s,sentenceZh:i.z,ans:[i.a],expZh:i.x})),corrections:items.map(i=>({sentence:i.w,sentenceZh:i.correctionZh||i.z,error:i.e,correct:i.c,expZh:i.x}))}}
const proper=[
['___ is the capital of France.','巴黎是法国的首都。','Paris',['Paris','paris','city','Capital'],'My cousin lives in paris.','paris','Paris','Paris是特定城市名称，属于专有名词，首字母大写。','我的表妹住在巴黎。'],
['We study ___ at school.','我们在学校学习英语。','English',['English','english','language','an English'],'Ben speaks english very well.','english','English','语言名称English是专有名词，首字母大写。','Ben英语说得很好。'],
['My friend ___ lives nearby.','我的朋友Lucy住在附近。','Lucy',['Lucy','lucy','girl','friend'],'Our new student is called lucy.','lucy','Lucy','具体人名Lucy必须大写。','我们的新同学叫Lucy。'],
['Today is ___.','今天是星期一。','Monday',['Monday','monday','day','the monday'],'The sports club meets every monday.','monday','Monday','星期名称属于专有名词，首字母大写。','体育俱乐部每周一活动。'],
['We visited ___ last summer.','我们去年夏天游览了意大利。','Italy',['Italy','italy','country','the italy'],'My penfriend comes from italy.','italy','Italy','国家名称Italy必须大写。','我的笔友来自意大利。'],
['The river is called the ___.','这条河叫泰晤士河。','Thames',['Thames','thames','river','Water'],'We took a boat trip on the thames.','thames','Thames','特定河流名称Thames是专有名词。','我们乘船游览了泰晤士河。'],
['___ is a large company.','Amazon是一家大公司。','Amazon',['Amazon','amazon','company','Shop'],'Dad ordered the book from amazon.','amazon','Amazon','公司名称Amazon是专有名词。','爸爸从Amazon订购了这本书。'],
['We celebrate ___ in December.','我们在十二月庆祝圣诞节。','Christmas',['Christmas','christmas','festival','holiday'],'Our family has lunch together at christmas.','christmas','Christmas','节日名称Christmas首字母大写。','我们一家在圣诞节一起吃午餐。'],
['My dog is named ___.','我的狗叫Max。','Max',['Max','max','dog','Animal'],'The winner of the dog show was max.','max','Max','动物的具体名字Max按专有名词处理。','宠物狗Max赢得了狗狗比赛。'],
['She lives on ___ Street.','她住在King街。','King',['King','king','street','Road'],'The museum is on king Street.','king','King','特定街道名称中的King要大写。','博物馆位于King街。'],
['___ is the first month.','一月是第一个月。','January',['January','january','month','Winter'],'Our new school term begins in january.','january','January','月份名称January是专有名词。','我们的新学期在一月开始。'],
['The ___ is a famous landmark.','埃菲尔铁塔是著名地标。','Eiffel Tower',['Eiffel Tower','eiffel tower','tower','Eiffel tower'],'We took a photo beside the eiffel tower.','eiffel tower','Eiffel Tower','地标名称中的主要单词首字母都要大写。','我们在埃菲尔铁塔旁拍了一张照片。'],
['A ___ is a place where books are kept.','图书馆是存放书籍的地方。','library',['library','London','Monday','Lucy'],'My brother borrowed a Book from school.','Book','book','library和book都泛指一类事物，是普通名词，在句中通常不大写。','我弟弟从学校借了一本书。'],
['My ___ teaches maths.','我的老师教数学。','teacher',['teacher','Mr Brown','England','Friday'],'A Doctor helped the injured cyclist.','Doctor','doctor','teacher和doctor都表示普通职业名称，不需要大写。','一位医生帮助了受伤的骑车人。'],
['The ___ is very busy.','这座城市很繁忙。','city',['city','Paris','China','July'],'The Village has a small post office.','Village','village','city和village都是普通地点名词，在句中不需要大写。','这个村庄有一家小邮局。'],
]
const count=[
