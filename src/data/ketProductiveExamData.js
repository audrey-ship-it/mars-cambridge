...
const sourceSets = [
  [1, 1, 'wear',
    ...
    story(1, 1, '两名男孩看见地上的钱；其中一人捡起钱；两人用钱购买冰淇淋。', 'Two boys were walking through town when they saw some money on the ground. One of them picked it up. They decided to go into a nearby café, where they bought two ice creams and enjoyed them together. They felt very happy about their unexpected treat.')],
  [1, 2, 'outdoors',
    ...
    story(1, 2, '一名男孩独自看篮球比赛；他把球传回球场；之后获邀加入比赛。', 'A boy was sitting beside a basketball court and watching a game. The ball came towards him, so he picked it up and threw it back. The players invited him to join them, and soon he was playing happily. He was excited to make some new friends.')],
  [1, 3, 'fun',
  ...
  [1, 4, 'subjects',
    ...
    story(1, 4, '两名朋友看到歌手演出海报；他们观看演唱会；演出后与歌手合影。', 'Two friends saw a poster for a concert and bought tickets. At the concert, they sang along and had a wonderful time. Afterwards, they met the singer, talked to him and took a photo together. It was an evening they would always remember.')],
  [2, 1, 'school',
  ...
  [2, 2, 'holiday',
    ...
    story(2, 2, '男孩庆祝生日并收到足球；之后带着新足球到球场射门。', 'A boy celebrated his birthday with his family. His father gave him a present, and he was excited to find a new football inside. Later, he took it outside and scored a goal at the football pitch. He smiled proudly as his family cheered for him.')],
  [2, 3, 'reading',
  ...
  [2, 4, 'home',
    ...
    story(2, 4, '女孩参加舞蹈排练；随后登台表演；演出结束后老师向她献花。', 'A girl practised dancing with her classmates for many weeks. On the day of the show, they performed beautifully in front of a large audience. At the end, their teacher gave the girl some flowers, and everyone applauded. She felt proud because all her hard work had succeeded.')],
]
